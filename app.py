...
- For criteria that are not met, provide a concise explanation of what is missing and a clear, actionable suggestion for improvement (1–2 sentences).
- For criteria that are partly met, briefly state what is covered, what is missing, and how the student can fully meet the criterion (1–2 sentences).
...
"""
        ...
        common_instructions = """
- Be concise. Use short sentences and avoid repeating information.
- If the assignment is long or you are running out of space, summarise feedback for each criterion in one or two sentences.
