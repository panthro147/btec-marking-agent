...
- Use a friendly, supportive tone—imagine you’re chatting with the student.
- Avoid formal or academic language; be clear and encouraging.
- Don’t rewrite the assignment.
- If the assignment is incomplete, review only what’s present.
- End with a brief summary saying if the assignment is good enough to pass, and encourage the student.
"""
            try:
